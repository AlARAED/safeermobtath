...
(function App() {
    ...
    const calendar = `<div class="container">
            <div class="row">
                <div class="col-md-10 m-auto col-12 d-flex">
                    <div class="card border-0 mt-2 flex-fill">
                ...
                <div class="col-md-10 m-auto col-12 d-flex pa-sm">
                    <div class="card border-0 mt-2 flex-fill d-none" id="event">
                        ...
                        <div class="card-body px-1 py-3">
                            ...
                            <div class="input-group events-input mb-3 col-10 mx-auto mt-2">
                                <input type="text" class="form-control" placeholder="From - To" id="eventTxt">
    ...
    $(function(){
        function showEvent(eventDate){
            ...
            if (storedEvents == null){
                ...
                if(eventsList.length>0){
                    ...
                    $('.events-today').html('<h5 class="text-center">No appointments found</h5 class="text-center">');
                }               
            }
        }
        function removeEvent(id){
            ...
            if(storedEvents != null){
                ...
                $('.toast-body').html('Your appointment have been removed');
                $('.toast').toast('show');
            }
        }        
        ...
        $(document).on('click', '#createEvent', function(){
            ...
            $('.error').remove();
            if (eventText == ''){
                $('.events-input').append(`<span class="error">Please enter appointment</span>`);
