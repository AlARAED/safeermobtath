                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <!--         <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">اعلاق</button>
                                                     -->
                                                    {!!  Form::open(['url' => ['admin/Lesson/remove',$Category->id],'id' => 'delete_form' ,'method' => 'POST','files' => true]) !!}
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    {!!  Form::open(['url' => ['admin/Lesson/update',$Category->id] ,'method' => 'POST','files' => true]) !!}
                                                    <br>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                {!!  Form::open(['url' => ['admin/storelesson'] ,'method' => 'POST','files' => true]) !!}
                                                <br>
                                                <div class="form-group">
                                                    <label class="control-label">اسم باللغةالعربية</label>
