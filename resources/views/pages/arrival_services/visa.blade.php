    ...
    <div class="container">
        ...
        <form method="POST" id="form_r" action="{{route(app()->getLocale().'.insurance')}}"  enctype="multipart/form-data">
            ...
            <div class="row form-group">
                ...
                <div class="col-8 col-md-3">
                    <select name="" id="service_type" class="form-control" disabled>
                        ...
                        <option value="3" selected>{{__('Visa')}}</option>
                ...
                <input type="hidden" id="mobile_no" class="form-control" name="type" value="3">
            ...
            <div class="scholarship m-auto w_max_content">
                <button class="form-control financial_g btn_newsletter mt-5" onclick="document.getElementById('getFile1').click()">{{__('Attach the passport')}}</button>
