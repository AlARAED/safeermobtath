                ...
                <div class="std_form">
                    <div class="row form-group">
                        ...
                        <div class="col-8 col-md-3">
                            <input type="text" id="user_name" class="form-control @error('name') is-invalid @enderror" name="name" required value="{{ Auth::user()->name }}">
                            @error('name')
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-8 col-md-3">
                            <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" name="email" required value="{{ Auth::user()->email }}">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-8 col-md-3">
                            <select name="country_mobtath_id" id="country_name" class="form-control" id="country-dropdown" required value="{{ Auth::user()->email }}">
