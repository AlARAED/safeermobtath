    ...
    <section class="profile_complete teacher_profile std_teacher_profile correspondence_teacher">
        <div class="container">
            ...
            <div class="profile_bg prof_head">
                ...
                <h5 class="f_w_400 text_d_underline">{{__('Plan your study with English language teacher')}} {{__('Adam Ali')}}</h5>
                ...
                <div class="bg_white">
                    ...
                    <div class="scholarship">
                        ...
                        <div class="m-auto w_max_content">
                            <button class="form-control btn_newsletter" onclick="document.getElementById('getFile13').click()">{{__('Attach the certificate')}}</button>
                            <input id="getFile13" type="file" class="d-none">
                        </div>
