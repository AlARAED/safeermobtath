        ...
        <section class="profile_complete">
            <div class="container">
                ...
                <form method="POST" id="form_r" action="{{route(app()->getLocale().'.teacher_lang')}}"  enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="first_name" class="form-control" name="type_service" value="4">
                    ...
                    <div class="profile_bg">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-8 col-md-4">
                                <input type="text"  class="form-control" name="phone_no" placeholder="+966_XXX_XXX" required>
                            </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-8 col-md-4">
                                <input type="text" id="email" class="form-control" name="field_Ph_type"  required >
                            </div>
                        </div>
