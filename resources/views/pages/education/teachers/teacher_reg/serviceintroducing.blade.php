        ...
        <section class="profile_complete">
            <div class="container">
                ...
                <form method="POST" id="form_r" action="{{route(app()->getLocale().'.teacher_lang')}}"  enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="first_name" class="form-control" name="type_service" value="5">
                    ...
                    <div class="profile_bg">
                        ...
                        <div class="row ">
                            <div class="col-4 col-md-2">
                                <h5 for="email">{{__('Service Type')}}</h5>
                            </div>
                            <div class="col-8 col-md-4">
                                <input type="text" id="email" class="form-control" name="Service_type"  required >
                            </div>
                        </div>
